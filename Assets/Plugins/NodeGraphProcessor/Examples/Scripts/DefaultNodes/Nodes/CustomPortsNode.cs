...
[Serializable] [NodeMenuItem("Custom/MultiPorts")]
public class CustomPortsNode : BaseNode
{
	...
	private void PullInputs(List<SerializableEdge> inputEdges) => values.AddRange(inputEdges.Select(e => e.passThroughBuffer).ToList());
