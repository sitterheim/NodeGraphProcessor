...
namespace NodeGraphProcessor
{
	...
	public class ExposedParameterFieldFactory : IDisposable
	{
		...
		public void Dispose() => Object.DestroyImmediate(exposedParameterObject);
		...
		private int FindPropertyIndex(ExposedParameter param) => exposedParameterObject.parameters.FindIndex(p => p == param);
	}
}