...
namespace NodeGraphProcessor
{
	...
	public class ExposedParameterDrawer : PropertyDrawer
	{
		...
		protected SerializedProperty GetSettingsProperty(SerializedProperty property) =>
			property.FindPropertyRelative(nameof(ExposedParameter.settings));
		...
		protected SerializedProperty GetNameProperty(SerializedProperty property) =>
			property.FindPropertyRelative(nameof(ExposedParameter.name));
	...
	public class GradientParameterDrawer : ExposedParameterDrawer
	{
		public override VisualElement CreatePropertyGUI(SerializedProperty property)
		{
			var name = GetNameProperty(property);
			var settings = GetSettingsProperty(property);
			var mode = (GradientParameter.GradientColorMode)settings.FindPropertyRelative(nameof(GradientParameter.GradientSettings.mode))
				.intValue;
	...
	public class ExposedParameterSettingsDrawer : PropertyDrawer
	{
		...
		public override VisualElement CreatePropertyGUI(SerializedProperty property) => CreateHideInInspectorField(property);
