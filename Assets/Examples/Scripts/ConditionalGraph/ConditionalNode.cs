...
namespace NodeGraphProcessor.Examples
{
	...
	public abstract class LinearConditionalNode : ConditionalNode, IConditionalNode
	{
		...
		public override IEnumerable<ConditionalNode> GetExecutedNodes() =>
			...
			outputPorts.FirstOrDefault(n => n.fieldName == nameof(executes))
				.GetEdges()
	...
	public abstract class WaitableNode : LinearConditionalNode
	{
		...
		protected void ProcessFinished() => onProcessFinished.Invoke(this);

		public IEnumerable<ConditionalNode> GetExecuteAfterNodes() => outputPorts.FirstOrDefault(n => n.fieldName == nameof(executeAfter))
			.GetEdges()
			.Select(e => e.inputNode as ConditionalNode);
	}
}